...
describe('AuthController', () => {
  ...
  describe('register', () => {
      it('should register a user and return the access token', async () => {
          const registerDto: RegisterDto = {email: 'test@example.com', password: 'password123', name: "Test User"};
          const result = {accessToken: 'some-token', user: {id: "1", ...registerDto}};
      ...
      it('should throw a ConflictException if email already exists', async () => {
          ...
          jest.spyOn(authService, 'register').mockRejectedValue(new ConflictException('Email already exists'));
    ...
    describe('login', () => {
        it('should log in a user and return the access token', async () => {
            ...
            const result = {accessToken: 'some-token', user: {id: '1', email: 'test@example.com', name: 'Test User'}};

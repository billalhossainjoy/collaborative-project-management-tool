...
describe('UsersService', () => {
  ...
  describe('create', () => {
      it('should create a new user', async () => {
          ...
          jest.spyOn(hashingProvider, 'hashPassword').mockResolvedValue(hashedPassword);
    ...
    describe('validateUser', () => {
        it('should validate a user successfully', async () => {
            ...
            expect(hashingProvider.comparePassword).toHaveBeenCalledWith(loginDto.password, user.password);
            expect(result).toEqual(user);
        });
    ...
    describe('findByEmail', () => {
        it('should return a user by email', async () => {
            ...
            expect(prismaService.user.findUnique).toHaveBeenCalledWith({where: {email: user.email}});
            expect(result).toEqual(user);
        });
    });
